...
export default function AnimatedStats() {
  ...
  return (
    <section ref={sectionRef} className="w-full py-12 md:py-24 lg:py-32 bg-white/90 backdrop-blur-sm">
        ...
        <div ref={cardsRef} className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="overflow-hidden transform-gpu transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-xl sm:text-2xl font-bold">Academic Programs</CardTitle>
              <BookOpen className="h-6 w-6 text-primary" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl sm:text-4xl font-bold stat-number">120</div>
          ...
          <Card className="overflow-hidden transform-gpu transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-xl sm:text-2xl font-bold">Enrolled Students</CardTitle>
              <GraduationCap className="h-6 w-6 text-primary" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl sm:text-4xl font-bold stat-number">25000</div>
              <p className="text-muted-foreground text-sm sm:text-base">Students from 50+ countries around the world</p>
            </CardContent>
            <CardFooter>
              <Link href="#" className="inline-flex items-center text-sm font-medium text-primary">
          ...
          <Card className="overflow-hidden transform-gpu transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            <div className="relative h-48 w-full">
              <Image src="/placeholder.svg?height=200&width=400" alt="Faculty & Staff" fill className="object-cover" />
            </div>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-xl sm:text-2xl font-bold">Faculty & Staff</CardTitle>
              <Users className="h-6 w-6 text-primary" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl sm:text-4xl font-bold stat-number">1500</div>
              <p className="text-muted-foreground text-sm sm:text-base">
          ...
          <Card className="overflow-hidden transform-gpu transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-xl sm:text-2xl font-bold">Admission Procedures</CardTitle>
              <ClipboardList className="h-6 w-6 text-primary" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl sm:text-4xl font-bold stat-number">4</div>
              <p className="text-muted-foreground text-sm sm:text-base">
